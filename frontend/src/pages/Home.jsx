  ...
  const features = [
    {
      ...
      description: 'Find your next favorite book from our vast collection of carefully curated titles',
      icon: '📚',
    ...
    {
      title: 'Track Reading',
      description: 'Keep track of books you\'ve read, currently reading, and your wishlist',
      icon: '📖',
    ...
    },
    {
      ...
      description: 'Get smart book suggestions based on your reading preferences and history',
      icon: '🎯',
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center py-16 sm:py-24 transform transition-all duration-700 ease-out ${
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Link to="/signup">
                <Button size="lg" className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200">
                  Get Started Free
                </Button>
              </Link>
              <Link to="/about">
                <Button variant="outline" size="lg" className="w-full sm:w-auto border-2 border-gray-300 text-gray-700 hover:border-blue-500 hover:text-blue-600 font-semibold py-3 px-8 rounded-lg transition-colors duration-200">
                  Learn More
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Everything you need to enhance your reading experience in one simple platform.
            </p>
          </div>
