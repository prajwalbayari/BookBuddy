    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-6 sm:py-8 xl:py-12">
        ...
        <div className="text-center mb-6 sm:mb-8 xl:mb-12">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-800 mb-3 sm:mb-4">
            Book Library
          </h1>
          <p className="text-base sm:text-lg xl:text-xl text-gray-600 max-w-2xl xl:max-w-4xl mx-auto px-4">
