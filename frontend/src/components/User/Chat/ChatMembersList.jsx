      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        <div className="flex items-center justify-between mb-3">
          <button
            ...
            className="flex items-center space-x-2 px-3 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors"
          >
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">{members.length} chat{members.length !== 1 ? 's' : ''}</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {members.length === 0 ? (
          <div className="p-6 text-center">
            <div className="mb-4">
              <div className="mx-auto h-12 w-12 bg-gray-200 dark:bg-gray-600 rounded-full flex items-center justify-center">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">Start a new chat to see it here</p>
          </div>
        ) : (
