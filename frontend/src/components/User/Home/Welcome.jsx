    ...
    <section className="py-12 bg-white rounded-lg shadow-sm border">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex flex-col items-center text-center">
          <div className="mb-8">
            <div className="w-24 h-24 lg:w-32 lg:h-32 bg-blue-600 rounded-2xl flex items-center justify-center shadow-lg">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8">
              <Link to="/user/books">
                <Button className="px-8 py-3 text-lg font-semibold bg-blue-600 hover:bg-blue-700 rounded-lg shadow-sm">
                  Explore Books
                </Button>
              </Link>
